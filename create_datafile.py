...
if args.ra is None:
	...
	print("Overriding RA in the config file by value supplied in command line")
	print("{} --> {}".format(configParser.getfloat('extrinsic', 'ra'), args.ra))
	ra = args.ra

if args.dec is None:
	dec = configParser.getfloat('extrinsic', 'dec')
else:
	print("Overriding dec in the config file by value supplied in command line")
	print("{} --> {}".format(configParser.getfloat('extrinsic', 'dec'), args.dec))
	dec = args.dec
...
print("Duration of the signal = {}".format(duration))
frame_start_time = int(t_coa - 2*duration) - 1
frame_end_time = int(t_coa + duration) + 1
frame_duration = frame_end_time - frame_start_time
print("Frame start time = {}".format(frame_start_time))
print("Frame duration = {}".format(frame_duration))
...
cmd_L = '''pycbc_condition_strain --injection-file {} \
                                  ...
                                  --output-strain-file L-L1_STRAIN-{}-{}-RA_{}-DEC_{}.gwf \
...
cmd_H = '''pycbc_condition_strain --injection-file {} \
                                  ...
                                  --output-strain-file H-H1_STRAIN-{}-{}-RA_{}-DEC_{}.gwf \
                                  --fake-strain-from-file {} \
                                  --fake-strain-seed 100 --low-frequency-cutoff 15 \
                                  --fake-strain-flow 15 --frame-duration {} \
                                  --gps-start-time {} --gps-end-time {} \
...
cmd_V = '''pycbc_condition_strain --injection-file {} \
                                  ...
                                  --output-strain-file V-V1_STRAIN-{}-{}-RA_{}-DEC_{}.gwf \
                                  --fake-strain-from-file {} \
                                  --fake-strain-seed 100 --low-frequency-cutoff 15 \
                                  --fake-strain-flow 15 --frame-duration {} \
                                  --gps-start-time {} --gps-end-time {} \
...
os.system("mv H-H1_STRAIN-{}-{}-RA_{}-DEC_{}.gwf frames/.".format(frame_start_time, frame_duration, args.ra, args.dec))
os.system("mv L-L1_STRAIN-{}-{}-RA_{}-DEC_{}.gwf frames/.".format(frame_start_time, frame_duration, args.ra, args.dec))
os.system("mv V-V1_STRAIN-{}-{}-RA_{}-DEC_{}.gwf frames/.".format(frame_start_time, frame_duration, args.ra, args.dec))
